...
public:
    ...
    pcl::PointCloud<PointType>::Ptr cloud_deskewed;  // original cloud deskewed
    pcl::PointCloud<PointType>::Ptr cloud_corner;    // extracted corner feature
    pcl::PointCloud<PointType>::Ptr cloud_surface;  // extracted surface feature
};
